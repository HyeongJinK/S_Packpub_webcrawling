...
while(checked) {
  ...
  url = "https://www.packtpub.com/all-books?search=Java&availability_list%5BAvailable%5D=Available&offset="+downBook+"&rows=48&sort=&theme_raw=true";
...
fs.writeFileSync("isbn_java.txt", isbnlist, 'utf-8', function(e){
  if(e){
